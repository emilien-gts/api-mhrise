...
class ArmorSynchronizer extends AbstractSynchronizer
{
    ...
    private function syncArmor(array $data): void
    {
        ...
        $a->armorSetId = SynchronizerUtils::array_value_to_int($data, 'series');
        $a->rarity = SynchronizerUtils::array_value_to_int($data, 'rare');
        $a->value = SynchronizerUtils::array_value_to_int($data, 'value');
        $a->value = SynchronizerUtils::array_value_to_int($data, 'value');
        $a->buyValue = SynchronizerUtils::array_value_to_int($data, 'buyValue');
        $a->defenseValue = SynchronizerUtils::array_value_to_int($data, 'defVal');
        $a->fireDefenseValue = SynchronizerUtils::array_value_to_int($data, 'fireRegVal');
        $a->waterDefenseValue = SynchronizerUtils::array_value_to_int($data, 'waterRegVal');
        $a->iceDefenseValue = SynchronizerUtils::array_value_to_int($data, 'iceRegVal');
        $a->thunderDefenseValue = SynchronizerUtils::array_value_to_int($data, 'thunderRegVal');
        $a->dragonDefenseValue = SynchronizerUtils::array_value_to_int($data, 'dragonRegVal');
